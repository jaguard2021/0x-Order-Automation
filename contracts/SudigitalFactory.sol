    ...
    ERC165
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("SudigitalFactory");
    ...
    struct SudigitalFactoryConstructorParams {
    ...
    constructor(
        SudigitalFactoryConstructorParams memory _SudigitalFactoryParams
    ) BaseRouter(_SudigitalFactoryParams.extensions) RoyaltyPaymentsLogic(_SudigitalFactoryParams.royaltyEngineAddress) {
        nativeTokenWrapper = _SudigitalFactoryParams.nativeTokenWrapper;
